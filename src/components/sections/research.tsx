        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
          <div className="space-y-12">
            ...
            >
              ...
              <p className="text-[16px] md:text-[20px] leading-[1.6] text-[#666666] font-[var(--font-roboto)]">
          ...
          <motion.div
            {...fadeInScale}
            className="relative aspect-video bg-[#F3F3F3] rounded-lg shadow-md hover:shadow-lg transition-shadow"
          >
