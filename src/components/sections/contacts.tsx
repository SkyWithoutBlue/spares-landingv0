...
export const Contacts = ({ className }: ContactsProps) => {
  return (
    <section id="contacts" className={cn('w-full bg-white text-black text-3xl', className)}>
      <div className="max-w-[1920px] mx-auto px-6 md:px-12 pt-20">
        <div className="flex flex-col lg:flex-row gap-12">
          {/* Карта */}
          <motion.div {...fadeInLeft} className="w-full lg:w-2/3">
