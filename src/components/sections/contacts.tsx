        ...
        <div className="flex flex-col lg:flex-row gap-12 items-start">
          ...
          <div className="w-full lg:w-1/3">
            <div className="space-y-8">
              <div>
                <h3 className="text-lg uppercase mb-2">АДРЕС:</h3>
                <p className="text-2xl font-roboto-condensed">
                  ZAHLINICKA 1325,<br />
              ...
              <div>
                <h3 className="text-lg uppercase mb-2">НОМЕР ТЕЛЕФОНА:</h3>
                <Link
                  href="tel:+420571850123"
                  className="text-2xl font-roboto-condensed hover:opacity-70 transition-opacity"
                >
                  +420 571 850 123
                </Link>
              </div>
              ...
              <div>
                <h3 className="text-lg uppercase mb-2">EMAIL:</h3>
                <Link
              ...
              <div>
                <h3 className="text-lg uppercase mb-4">НАПИСАТЬ В ТЕЛЕГРАМ ИЛИ WHATS APP</h3>
                <div className="flex gap-4">
                  <Link
                    href="#"
                    className="px-8 py-3 border-2 border-black uppercase hover:bg-black hover:text-white transition-colors"
                  >
                    TELEGRAM
                  </Link>
                  <Link
